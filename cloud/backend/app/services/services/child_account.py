...
from app.repositories import PoolRepository
...
class ChildAccountService:
    ...
    def __init__(self, pool_repo: PoolRepository):
    ...
    def create_child_account(
        ...
        try:
            ...
            print(f"Error creating child account: {exc}")
            return None
...
def create_child_account_service(pool_session: Session) -> ChildAccountService:
    return ChildAccountService(PoolRepository(pool_session))
