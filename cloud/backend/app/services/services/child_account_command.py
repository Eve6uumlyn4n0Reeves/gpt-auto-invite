...
class ChildAccountCommandService:
    ...
    def auto_pull_child_accounts(
        ...
        try:
            ...
            if team_id:
                # 获取指定团队的成员
                members = provider.list_members(access_token, mother_id, team_id)
                ...
                teams_to_process = []
                for team in teams:
                    members = provider.list_members(access_token, mother_id, team.team_id)
    ...
    def sync_child_accounts(
        ...
        try:
            ...
            if mother.access_token_enc:
                access_token = decrypt_token(mother.access_token_enc)
                provider_members = provider.list_members(access_token, mother_id, team_id)
