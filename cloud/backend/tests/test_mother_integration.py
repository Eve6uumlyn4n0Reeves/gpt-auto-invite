...
def mother_command_service(pool_session):
    ...
    pool_repo = PoolRepository(pool_session)
    return MotherCommandService(pool_session, mother_repo, pool_repo)
...
def mother_query_service(pool_session):
    ...
    mother_repo = MotherRepository(pool_session)
    pool_repo = PoolRepository(pool_session)
    return MotherQueryService(pool_session, mother_repo, pool_repo)
