...
class MotherSummary:
    ...
    # 关联数据
    teams: list[MotherTeamSummary] = field(default_factory=list)
    children: list[MotherChildSummary] = field(default_factory=list)
    seats: list[MotherSeatSummary] = field(default_factory=list)
