...
class ErrorCode:
    ...
    MOTHER_GROUP_NOT_FOUND = "MOTHER_GROUP_NOT_FOUND"
...
class MotherGroupNotFoundError(NotFoundError):
    """母号分组不存在错误"""

    def __init__(self, group_id: int):
        super().__init__(
            message=f"母号分组 {group_id} 不存在",
            resource_type="MotherGroup",
            details={"mother_group_id": group_id},
        )
