...
@pytest.fixture
def mother_command_service(mock_pool_session, mock_mother_repository):
    """Mother命令服务实例"""
    return MotherCommandService(mock_pool_session, mock_mother_repository)


@pytest.fixture
def mother_query_service(mock_pool_session, mock_mother_repository):
    """Mother查询服务实例"""
    return MotherQueryService(mock_pool_session, mock_mother_repository)
